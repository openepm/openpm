...
SCENARIOS: Dict[str, ScenarioSpec] = {
    "easy": ScenarioSpec(
        ...
        max_days=8,
        tasks=[
            TaskSeed("T1", "Implement login form", "high", "frontend", 2.0, 3, []),
            TaskSeed("T2", "Create auth API", "critical", "backend", 2.0, 4, []),
            TaskSeed("T3", "Add smoke tests", "medium", "qa", 1.5, 6, ["T1", "T2"]),
        ],
        developers=[
    ...
    "medium": ScenarioSpec(
        ...
        max_days=10,
        tasks=[
            TaskSeed("M1", "Design DB schema", "high", "backend", 2.0, 3, []),
            TaskSeed("M2", "Build API endpoints", "critical", "backend", 3.0, 6, ["M1"]),
            TaskSeed("M3", "Implement dashboard", "high", "frontend", 2.5, 7, ["M2"]),
            TaskSeed("M4", "Integration testing", "medium", "qa", 2.0, 9, ["M2", "M3"]),
        ],
        developers=[
